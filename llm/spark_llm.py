...
class Spark_LLM(Self_LLM):
    ...
    def _call(self, prompt: str, stop: Optional[List[str]] = None,
              ...
              **kwargs: Any):
        if self.api_key is None or self.appid is None or self.api_secret is None:
            # 三个 Key 均存在才可以正常调用
            print("请填入 Key")
        ...
        # 发起请求
        try:
            response = spark_main(self.appid, self.api_key, self.api_secret, self.url, self.domain, question,
